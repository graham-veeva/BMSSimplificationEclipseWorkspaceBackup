trigger BMS_SURVEY_UPDATE_TERRITORYFIELDS_CORE on Assessment__c (before insert, before update) {
                            ...
                            if(TerritoryIDS.containsKey(uid ))
                                          {
                                                     ...
                                                     Terr1 = Terr.get(IDD);
                                                        ...
                                                        Trigger.new[i].Sales_Force_Name_BMS__c  = Terr1.Sales_Force_Name_BMS_CORE__c;
                                                     
                                                        Trigger.new[i].Territory_Business_Code_BMS__c = Terr1.Territory_Business_Code_BMS_CORE__c;
                                                        Trigger.new[i].Territory_Function_Code_BMS__c = Terr1.Territory_Function_Code_BMS_CORE__c;
                                                        Trigger.new[i].Territory_Region_Code_BMS__c = Terr1.Territory_Region_Code_BMS_CORE__c;
                                                        Trigger.new[i].Territory_Sales_Area_Code_BMS__c = Terr1.Territory_Sales_Area_Code_BMS_CORE__c;
                                                        Trigger.new[i].BMS_Code_ID__c= Terr1.Code_ID_BMS_CORE__c;                 
          } 
