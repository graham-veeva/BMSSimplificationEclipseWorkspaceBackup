trigger VOD_CONTRACT_LINE_AFTER_INSUPD on Contract_Line_vod__c (after insert, after update) {
    ...
    Map<Id, Contract_vod__c> contractMap = new Map<Id, Contract_vod__c>([SELECT Id, Status_vod__c, (SELECT EM_Speaker_vod__c, Status_vod__c
